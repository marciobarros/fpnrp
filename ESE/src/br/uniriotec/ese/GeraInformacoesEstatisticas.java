...
public class GeraInformacoesEstatisticas {
	...
	public static void geraScriptR(String nomeTabelaMQ, String nomeTabelaEVM, String nomeTabelaEvolutionMQ) throws Exception {
		...
		for (String informacao : informacoes) {
			...
			fileWriterPacotes.append("# vetor com as aplicacoes \r\n");
			fileWriterPacotes.append("# aplicacoes"+informacao+"<-names(table(tabela"+informacao+"PSEUDO$"+ParserSimpl.CABECALHO_APLICACAO+"))\r\n");
			fileWriterPacotes.append("# para exibir na ordem facilitando conferência dos valores \r\n");
			fileWriterPacotes.append("aplicacoes"+informacao+"<-c("+Aplicacao.valores()+") \r\n");
			...
			fileWriterPacotes.append("\r\n");
			fileWriterPacotes.append("	# calculo da solucao \r\n");
			...
			fileWriterPacotes.append("\r\n");
			fileWriterPacotes.append("	# calculo do tempo de execucao \r\n");
			fileWriterPacotes.append("	mediaET"+informacao+"Pseudo[proj]<-round(mean(tabela"+informacao+"PSEUDOProj$"+ParserSimpl.CABECALHO_TEMPO_DE_EXECUCAO+"),1)\r\n");
			...
			fileWriterPacotes.append("\r\n");
			fileWriterPacotes.append("	mediaRR"+informacao+"Pseudo[proj] <- round(mean(tabela"+informacao+"PSEUDOProj$"+ParserSimpl.CABECALHO_NUMEROS_DE_RESTART+"),1)\r\n");
			fileWriterPacotes.append("	desvioPadraoRR"+informacao+"Pseudo[proj] <- round(sd(tabela"+informacao+"PSEUDOProj$"+ParserSimpl.CABECALHO_NUMEROS_DE_RESTART+"),1)\r\n");
			fileWriterPacotes.append("	RR"+informacao+"Sobol[proj] <- round(tabela"+informacao+"SOBOLProj$"+ParserSimpl.CABECALHO_NUMEROS_DE_RESTART+",0)\r\n");
			fileWriterPacotes.append("	i<-i+1\r\n");
			fileWriterPacotes.append("}\r\n");
			fileWriterPacotes.append("\r\n");
			fileWriterPacotes.append("# gerando tabelas de resultados \r\n");
		...
		fileWriterPacotes.append("projetosGraficos<-c(\"XMLDOM\",\"DOM4J\",\"SEEMP\")\r\n");
		fileWriterPacotes.append("for ( proj in projetosGraficos ) {\r\n");
		fileWriterPacotes.append("\r\n");
		...
		fileWriterPacotes.append("dev.off()\r\n");
		fileWriterPacotes.append("}\r\n");
