...
# Load data
fpdata <- read.table(file="/Users/Marcio/Desktop/Codigos/fpnrp/result/ciclos/parm2 fpnrp.txt", sep=" ", header=TRUE);
cldata <- read.table(file="/Users/Marcio/Desktop/Codigos/fpnrp/result/ciclos/parm2 clnrp.txt", sep=" ", header=TRUE);
